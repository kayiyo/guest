...
def add_guest(request):
    ...
    real_name = request.POST.get('real_name','')       # 姓名
    ...
    try:
        Guest.objects.create(real_name=real_name, phone=int(phone), email=email, sign=0, event_id=int(eid))
...
def get_guest_list(request):
    ...
    if eid != '' and phone != '':
        ...
        try:
            ...
            guest['real_name'] = results.real_name
